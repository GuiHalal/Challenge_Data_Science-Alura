...
-- traduzindo os dados da coluna HISTORICO_INADIMP
-- **********************************************
UPDATE dados_juntos SET HISTORICO_INADIMP = 'S'
WHERE HISTORICO_INADIMP = 'Y';

select distinct HISTORICO_INADIMP from dados_juntos;
